...
export const FETCH_MOVIES_FULFILLED = 'FETCH_MOVIES_FULFILLED';          //bu actionlari bele yazmagimiza sebeb redux promise middleware-den istifade etmeyimizdir
export const FETCH_MOVIES_REJECTED = "FETCH_MOVIES_REJECTED";

export const DELETE_MOVIE_PENDING = 'DELETE_MOVIE_PENDING';
export const DELETE_MOVIE_FULFILLED = 'DELETE_MOVIE_FULFILLED';          //bu actionlari bele yazmagimiza sebeb redux promise middleware-den istifade etmeyimizdir
